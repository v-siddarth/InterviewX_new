// frontend/src/App.jsx - MINIMAL VERSION
...
function App() {
  ...
  useEffect(() => {
    ...
    // Initialize admin mock data in development
    if (process.env.NODE_ENV === 'development') {
      adminStore.generateMockData();
    }
  }, []);
...
//   // Initialize admin mock data once in development
//   useEffect(() => {
//     if (process.env.NODE_ENV === 'development') {
//       generateMockData();
//     }
...
//       validateToken();
//     }
//   }, [isAuthenticated, user?._id]); // Only depend on stable values
